...
export default class nav extends Component{
    render(){
        return (         
          <View style={{flexDirection:'row',alignSelf:'stretch',height:40,alignItems:'center',justifyContent:'space-between',backgroundColor:MomEnv.NAVBAR_BG_COLOR}}>
                ...
                <Text style={{color:MomEnv.NAVBAR_TITLE_COLOR,fontSize:16}}>{this.props.title}</Text>
